...
class GameScene extends Phaser.Scene {
    ...
    initStage() {
        this.cat1 = this.physics.add.sprite(-30, 0, 'cat1_1');
        this.cat2 = this.physics.add.sprite(-30, 0, 'cat2_1');
            ...
            if (data.type == 0) {
                ...
                switch (this.status) {
                    ...
                    case 2:
                        ...
                        // 设置横向移动
                        // 设置横向移动
                        this.cat1.setVelocityX(10);
                        this.cat2.setVelocityX(-10);
                        // 碰撞检测
    ...
    onCollide() {
        ...
        // 停止移动
        this.cat1.setVelocityX(0);
        this.cat2.setVelocityX(0);
        ...
        this.yanhua = this.add.sprite(this.cat1.x + 30, this.cat1.y - 150, 'yanhua-1');
    ...
    closeXiCard() {
        ...
        this.xiCardContainer.classList.remove('image-wrapper');
    }
    ...
    showXiCard() {
        if (this.status == 2) {
            ...
            requestAnimationFrame(() => {
                this.xiCardContainer.classList.add('image-wrapper');
            });
        }
    }
